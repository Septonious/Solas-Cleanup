...
vec3 lightColRaw = mix(lightNight, mix(vec3(lightSun.r, lightSun.g, lightSun.b * (2.5 - clamp((mefade + timeBrightness) * 8.0, 0.0, 1.5))), normalize(skyColor + 0.0001), 0.1), sunVisibility * sunVisibility);
#else
